...
INSERT INTO `blog` (`blog_id`,`name`,`email`,`subject`,`message`,`dor`)
VALUES(301, 'ashwini','ashwini@gmail.com','testing','testing the website','2020-11-09');
...
INSERT INTO `register` (`register_id`, `firstname`, `lastname`, `address`, `village`, `taluka`, `district`, `state`,`email`, `username`, `gender`, `mobile`,`dor`)
VALUES(1, 'Brian', 'Msyamboza', 'P.O. Box 32153','fgrfg','ujyh','fgg','yhhgt','shubhangighadge45@gmail.com', 'shubh', 'female', '1234567890','2019-07-11');
...
CREATE TABLE `jobapply` (
  `apply_id` int(11) NOT NULL,
   `skills` varchar(256) DEFAULT NULL,
    `availabilty` varchar(256) DEFAULT NULL,
...
INSERT INTO `jobapply` (`apply_id`, `skills`,`availabilty`,`availablefrom`, `till`,`name`,`email`,`phn`,`village`,`taluka`,`district`,`state`,`dor`,`job_id`)
VALUES(201,'planting','group','2020-09-11','2020-09-14','shubh','shubh@gmail.com','3456766123','abc','pqr','xyz','mno','2020-06-11',101);
...
CREATE TABLE `jobs_master` (
  `job_id` int(11) NOT NULL,
   `jobkey` varchar(256) DEFAULT NULL,
    `requirementofworkers` int(11) DEFAULT NULL,
     `requiredfrom` date DEFAULT NULL,
      `till` date DEFAULT NULL,
...
INSERT INTO `jobs_master` (`job_id`,`jobkey`,`requirementofworkers`,`requiredfrom`, `till`, `jobvillage`,`jobtaluka`,`jobdistrict`,`jobstate`,`mob`,`jobby`, `jobdesc`, `jobdate`)
VALUES(101, 'planting',20,'2020-09-11','2020-09-14', 'wadgaon', 'haveli','pune', 'maharashtra','1234567890','jobby','jobdesc','2020-09-11');
...
ALTER TABLE `jobapply`
  ...
  ALTER TABLE `blog`
  MODIFY `blog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
