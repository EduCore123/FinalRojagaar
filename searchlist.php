...
<html lang="en">
 ...
 <body>
    ...
    <?php $_SESSION['currentPage'] = 'searchlist'; ?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-3"><a href="home.php"><?php echo $lang['home'] ?>     <i class="ion-ios-arrow-forward"></i></a></span> <span><?php echo $lang['job'] ?></span></p>
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 col-md-10">
                <div class="job-post-item-header d-flex align-items-center">
                  ...
                  <span><?= $record['jobdate'] ?></span></div>
                <div class="job-post-item-body d-block d-md-flex">
                  <div class="col-3 pl-0"> <label><?php echo $lang['jobdesc'] ?>:<span style="color: black"><?= $record['jobdesc'] ?></span></label></div>
                  <div class="col-3 pl-0"> <label><?php echo $lang['jobby'] ?>:<span  style="color: black"><?= $record['jobby'] ?></span></label></div>
                  <div class="col-3 pl-0"> <label><?php echo $lang['mobileno'] ?>:<span  style="color: black"><?= $record['mob'] ?></span></label></div>

                   <div class="col-3 pl-0"> <label><?php echo $lang['jobadd'] ?>:<span  style="color: black"><?= $record['jobvillage'] ?>,<?= $record['jobtaluka'] ?>,<?= $record['jobdistrict'] ?>,<?= $record['jobstate'] ?></span></label></div>
                </div>
              </div>
